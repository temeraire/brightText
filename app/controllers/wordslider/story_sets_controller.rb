class Wordslider::StorySetsController < WordsliderController
  ...
  def create
    ...
    respond_to do |format|
      if @story_set.save
        ...
        format.html { redirect_to("/wordslider/story_sets?filter=" + @story_set.category_id.to_s ) }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to wordslider_story_sets_path(:filter => @story_set.category_id.to_s) }
      format.xml  { head :ok }
    end
  end
  ...
  def reorder_story_sets_rank
    if( params[:category_id].blank? )
      redirect_to wordslider_story_sets_path
  ...
  def update_story_sets_rank
    ...
    redirect_to wordslider_story_sets_path(:filter => params[:filter])
  end
end
